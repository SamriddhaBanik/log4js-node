...
/** 
 * Chnaged so that there is not such master process and all the child processes act as masters
 */
function isPM2Master() {
  return config.pm2 && process.env[config.pm2InstanceVar] !== undefined;
}
